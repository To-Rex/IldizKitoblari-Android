class AudioFragment {
  ...
  AudioFragment({this.message, this.status, this.data});

  AudioFragment.fromJson(Map<String, dynamic> json) {
...
class Result {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (file != null) data['file'] = file!.toJson();
    data['locked'] = locked;
...
class Product {
  ...
  Product({this.sId, this.name, this.audioPrice, this.image});
